...
import in.srain.cube.views.ptr.demo.ui.activity.PtrLoadMoreActivity;
...
public class PtrDemoHomeFragment extends BlockMenuFragment {
    ...
    protected void addItemInfo(ArrayList<BlockMenuFragment.MenuItemInfo> itemInfos) {
        ...
        itemInfos.add(newItemInfo(R.string.ptr_demo_loadmore, R.color.cube_mints_4d90fe, new OnClickListener() {

            @Override
            public void onClick(View v) {
                startActivity(new Intent(getContext(), PtrLoadMoreActivity.class));
            }
        }));
